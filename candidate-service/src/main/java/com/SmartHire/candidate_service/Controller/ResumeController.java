...
public class ResumeController
{
            ...
            @RequestBody Resume resume)
    {
        return ResponseEntity
                ...
                .body(service.saveResume(resume));
    }

    @GetMapping("/candidate/{candidateId}")
    public ResponseEntity<Resume> getResumeByCandidateId(
            @PathVariable int candidateId)
    {
        return ResponseEntity.ok(
                service.getResumeByCandidateId(candidateId));
    }

    @PutMapping("/candidate/{candidateId}")
    public ResponseEntity<Resume> updateResume(
            @PathVariable int candidateId,
            @RequestBody String newResumeText)
    {
        return ResponseEntity.ok(
    ...
    public ResponseEntity<Void> deleteResume(
            @PathVariable int candidateId)
    {
        service.deleteResume(candidateId);
